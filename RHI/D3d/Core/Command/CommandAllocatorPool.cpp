...
D3dGraphicsCore::CommandAllocatorPool::~CommandAllocatorPool()
{
    Shutdown();
}

void D3dGraphicsCore::CommandAllocatorPool::Create(ID3D12Device* pDevice)
{
    m_Device = pDevice;
}

void D3dGraphicsCore::CommandAllocatorPool::Shutdown()
{
...
ID3D12CommandAllocator* D3dGraphicsCore::CommandAllocatorPool::RequestAllocator(uint64_t CompletedFenceValue)
{
...
void D3dGraphicsCore::CommandAllocatorPool::DiscardAllocator(uint64_t FenceValue, ID3D12CommandAllocator* Allocator)
{
    std::lock_guard<std::mutex> LockGuard(m_AllocatorMutex);
