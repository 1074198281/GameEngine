...
#define VALID_COMPUTE_QUEUE_RESOURCE_STATES \
    ...
    public:
        ...
        void SetBlendFactor(D3dColor::Color BlendFactor);
    ...
    inline void GraphicsContext::SetBlendFactor(D3dColor::Color BlendFactor)
    {
    ...
    {
        ExecuteIndirect(D3dGraphicsCore::DrawIndirectCommandSignature, ArgumentBuffer, ArgumentBufferOffset);
    }
    ...
    {
        ExecuteIndirect(D3dGraphicsCore::DispatchIndirectCommandSignature, ArgumentBuffer, ArgumentBufferOffset);
    }
