    ...
    _In_ D3D12_CPU_DESCRIPTOR_HANDLE textureView)
{
...

    {
        ...
        if (SUCCEEDED(hr))
        {
            D3dGraphicsCore::GpuResource DestTexture(*texture, D3D12_RESOURCE_STATE_COPY_DEST);
            D3dGraphicsCore::CommandContext::InitializeTexture(DestTexture, subresourceCount, initData.get());
        }
    }
