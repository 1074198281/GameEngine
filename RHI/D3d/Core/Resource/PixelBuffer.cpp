...
DXGI_FORMAT D3dGraphicsCore::PixelBuffer::GetBaseFormat(DXGI_FORMAT defaultFormat)
{
...
DXGI_FORMAT D3dGraphicsCore::PixelBuffer::GetUAVFormat(DXGI_FORMAT defaultFormat)
{
    switch (defaultFormat)
    {
...
DXGI_FORMAT D3dGraphicsCore::PixelBuffer::GetDSVFormat(DXGI_FORMAT defaultFormat)
{
    switch (defaultFormat)
    {
        // 32-bit Z w/ Stencil
...
DXGI_FORMAT D3dGraphicsCore::PixelBuffer::GetDepthFormat(DXGI_FORMAT defaultFormat)
{
    switch (defaultFormat)
    {
        // 32-bit Z w/ Stencil
...
DXGI_FORMAT D3dGraphicsCore::PixelBuffer::GetStencilFormat(DXGI_FORMAT defaultFormat)
{
    switch (defaultFormat)
    {
        // 32-bit Z w/ Stencil
...
//--------------------------------------------------------------------------------------
size_t D3dGraphicsCore::PixelBuffer::BytesPerPixel(DXGI_FORMAT Format)
{
    switch (Format)
    {
...
void D3dGraphicsCore::PixelBuffer::AssociateWithResource(ID3D12Device* Device, const std::wstring& Name, ID3D12Resource* Resource, D3D12_RESOURCE_STATES CurrentState)
{
...
D3D12_RESOURCE_DESC D3dGraphicsCore::PixelBuffer::DescribeTex2D(uint32_t Width, uint32_t Height, uint32_t DepthOrArraySize,
...
void D3dGraphicsCore::PixelBuffer::CreateTextureResource(ID3D12Device* Device, const std::wstring& Name,
...
void D3dGraphicsCore::PixelBuffer::ExportToFile(const std::wstring& FilePath)
{
