...
D3dGraphicsCore::LinearAllocatorPageManager::LinearAllocatorPageManager()
{
...
D3dGraphicsCore::LinearAllocatorPageManager D3dGraphicsCore::LinearAllocator::sm_PageManager[2];
...
D3dGraphicsCore::LinearAllocationPage* D3dGraphicsCore::LinearAllocatorPageManager::CreateNewPage(size_t PageSize)
{
...
void D3dGraphicsCore::LinearAllocator::CleanupUsedPages(uint64_t FenceID)
{
...
D3dGraphicsCore::DynAlloc D3dGraphicsCore::LinearAllocator::AllocateLargePage(size_t SizeInBytes)
{
...
D3dGraphicsCore::DynAlloc D3dGraphicsCore::LinearAllocator::Allocate(size_t SizeInBytes, size_t Alignment)
{
